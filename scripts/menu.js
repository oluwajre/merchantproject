    ...
    menuList: [
          ...
          {name: 'Admin Controls', icon: icons.adminControls,
            dropDown: [
              ...
              {name: 'Link Account', icon: icons.subMenu, headerName: 'Manage Link Merchants', link: './link_merchant.html'},
              {name: "Credit Merchant's Account", icon: icons.subMenu, headerName: 'Credit Merchant', link: './credit_superdealer.html'},
              {name: "Approvals", icon: icons.subMenu, headerName: 'Reversal Approval', link: './reversal_approval.html'},
              {name: "Reversal/Credit Merchant", icon: icons.subMenu, headerName: 'Reversal Emails and Update', link: './send_email_and_update_credit.html'},
              ...
              {name: "Current Administrators", icon: icons.subMenu, headerName: 'Current Administrators', link: './current_administrators.html'},
              {name: "Merchants and Discount", icon: icons.subMenu, headerName: 'Merchant and Provider Discounts', link: './merchants_and_providers.html'},
